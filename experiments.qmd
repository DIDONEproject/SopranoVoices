...
# This report is rendered once per experiment.
...
message("Running experiment ", experiment)
...
knitr::opts_chunk$set(
  ...
  fig.path = paste0("experiments_files/experiment_", params$experiment, "/")
)
...
for (name in names(datasets_to_save)) {
  ...
  # Construct filename
  file_name <- paste0("results/y_hats/", tolower(name), "_", experiment,
                      ".csv")
